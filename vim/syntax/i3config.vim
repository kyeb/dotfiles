...
syn keyword SwayKeyword output xwayland contained
...
syn match Sway /^\s*output\?\s\+.*$/ contains=SwayKeyword
syn match Sway /^\s*xwayland\?\s\+.*$/ contains=SwayKeyword
...
hi! def link SwayKeyword                             Identifier
